...
**Ce dépôt est le portage Laravel** d'une app Node/Fastify d'origine (`../wascal-cape-coast-2026`),
refait pour tourner sur un **hébergement mutualisé Hostinger Premium** (PHP + MySQL, sans VPS, sans Node).
Le **front est réutilisé tel quel** ; seule la couche serveur a été réécrite en Laravel.
...
- **Parité avec l'app Node d'origine** (`../wascal-cape-coast-2026/files`) : mêmes contrats d'API, mêmes
